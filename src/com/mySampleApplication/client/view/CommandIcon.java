...
/**
 * An composite {@link com.google.gwt.user.client.ui.Widget} displaying an {@link com.google.gwt.user.client.ui.Image} that executes a {@link com.google.gwt.user.client.Command} when
 * clicked.
 * 
 * @since 1.0
 */
public class CommandIcon extends Composite implements HasAllMouseHandlers {
    ...
    public CommandIcon(final Image image, ClickHandler handler) {
        this.image = image;
        initWidget(image);
